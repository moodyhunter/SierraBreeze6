...
namespace SierraBreeze
{
    ...
    DetectDialog::DetectDialog(QObject *parent) : QObject(parent)
    {
    }
    ...
    void DetectDialog::detect()
    {
        QDBusMessage message =
            QDBusMessage::createMethodCall(QStringLiteral("org.kde.KWin"), QStringLiteral("/KWin"), QStringLiteral("org.kde.KWin"), QStringLiteral("queryWindowInfo"));
